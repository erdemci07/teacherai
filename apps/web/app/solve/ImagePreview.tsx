...
export function ImagePreview({ file, previewUrl, previewAvailable, disabled, onRemove, onReplace, onPreviewError }: ImagePreviewProps) {
  return (
    <div className="imagePreview questionPreviewCard">
      <div className="questionPreviewMedia">
      ...
      <div className="fileMeta questionPreviewMeta">
        <div>
          <span className="fileMetaLabel">Seçilen soru</span>
