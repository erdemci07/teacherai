...
def plan(original="3x + 7 = 19",final="x = 4",steps=None):
    analysis=VisionAnalysis(request_id="v1",subject="mathematics",exam_context="TYT",topic="Denklem",subtopic="Doğrusal",question_type="open",language="tr",difficulty="easy",question_text=original,mathematical_expressions=[original],answer_choices=[],visual_elements=VisualElements(has_diagram=False,has_graph=False,has_table=False,has_geometry_figure=False,description=None),ocr_uncertainties=[],confidence=.99,provider="mock",model="mock",processing_time_ms=1)
