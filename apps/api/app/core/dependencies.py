...
def get_interaction_service(container: Annotated[Container, Depends(get_container)]) -> InteractionService:
...
def get_share_service(container: Annotated[Container, Depends(get_container)]) -> ShareService:
