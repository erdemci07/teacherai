...
- [`architecture/lessonplan-json-standard.md`](architecture/lessonplan-json-standard.md) defines the professional LessonPlan JSON standard that every AI-generated explanation must use across math, physics, chemistry, biology, geometry, renderer, voice, animation, video, comments, and datasets.
